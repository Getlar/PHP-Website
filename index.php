...
<link rel="icon" type="image/png" href="ikon.ico"/>
<link rel="stylesheet" type="text/css" href="styles.css">
<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@500&display=swap" rel="stylesheet">
</head>
<body>
  <h1 class="info">Név: Takács Tamás</h1>
  <h1 class="info">Neptun kód: CJRNIE</h1>
  <h1 class="info">Általam kigondolt érdemjegy: 5</h1>
...
<?php
  ...
  if(isset($_POST['username']) && isset($_POST['password'])){
    ...
    if(($megtalaltamuser==1) && ($megtalaltampassword ==0)){
      ...
      ?><script type="text/javascript">
        window.alert("Hibás felhasználó!");
      ...
      ?><script type="text/javascript">
        window.alert("Ez egy nagyon rossz próbálkozás volt!")
        window.location.href = "";
        header("Refresh:0");
      </script>
      <?php
